...
const ContentDetails = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-12 gap-2 border p-2">
			<div className="flex items-start justify-between flex-wrap gap-5 h-[200px] relative col-span-10 border-r pr-2">
				...
				<div>
					...
					<div className="absolute bottom-0 right-2">
						<p>
							...
							<small>
								<i>
									Batch 1, Batch 2, Batch 3, For both online
									and physical students
								</i>
							</small>
						</p>
					</div>
...
const ManageContent = () => {
	return (
		<div className="border px-2 py-5 flex justify-between flex-wrap gap-5">
			<div className=" flex items-start gap-x-3 ">
				<div className="flex items-center gap-x-3">
					<Checkbox className=" border border-black" />
					<Folder size={40} />
